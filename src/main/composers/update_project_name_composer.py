...
from src.data.use_cases.update_project_name import UpdateProjectName
from src.presentation.controllers.update_project_name_controller import UpdateProjectNameController
from src.presentation.http_types.http_request import HttpRequest
from src.presentation.http_types.http_response import HttpResponse
from typing import Callable

def update_project_name_composer() -> Callable[[HttpRequest], HttpResponse]:
    return UpdateProjectNameController(
        create_history_project_case=CreateHistoryProject(
            history_project_repository=HistoryProjectRepository(
                db_connection_handler=db_connection_handler_factory()
            )
        ),
        update_project_name_case=UpdateProjectName(
