...
@routes.post("/")
async def create_user(body:CreateUserFormat, request:Request):
    try:
...
@routes.delete("/")
async def delete_user(body:DeleteUserFormat, request:Request):
    try:
...
async def update_password(body:UpdateUserPasswordFormat, request:Request):
    try:
...
@routes.patch("/email")
async def update_email(body:UpdateUserEmailFormat, request:Request):
    try:
