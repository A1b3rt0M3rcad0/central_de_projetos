...
@routes.post('/')
async def create_empresa(body:CreateEmpresaFormat, request:Request):
    try:
...
@routes.delete('/')
async def delete_empresa(body:DeleteEmpresaFormat, request:Request):
    try:
...
@routes.patch('/')
async def update_empresa(body:UpdateEmpresasFormat, request:Request):
    try:
