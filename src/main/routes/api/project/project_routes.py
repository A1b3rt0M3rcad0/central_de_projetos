...
async def find_project(project_id, request:Request):
    try:
...
@routes.patch('/name')
async def update_project_name(body:UpdateProjectNameFormat, request:Request):
    try:
...
async def update_project_andamento(body:UpdateProjectAndamentoFormat, request:Request):
    try:
...
async def update_end_date(body:UpdateEndDateProjectFormat, request:Request):
    try:
...
async def update_expected_completion_date(body:UpdateExpectedCompletionDateFormat, request:Request):
    try:
...
async def update_start_date(body:UpdateStartDateFormat, request:Request):
    try:
...
@routes.patch('/verba')
async def update_project_verba(body:UpdateVerbaFormat, request:Request):
    try:
