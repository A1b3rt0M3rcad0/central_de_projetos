...
async def find_project_empresa(empresa_id:int, project_id:int, request:Request):
    try:
...
async def find_all_projects_from_empresa(empresa_id:int, request:Request):
    try:
        request.path_params['empresa_id'] = empresa_id
...
@routes.post('/')
async def create_project_empresa(body:CreateProjectEmpresaFormat, request:Request):
    try:
...
@routes.delete('/')
async def delete_project_empresa(body:DeleteProjectEmpresaFormat, request:Request):
    try:
