...
class TStringConnection(IStringConnection):
    ...
    def __init__(self) -> None:
        ...
        self.DATABASE = os.getenv('TDATABASE')
        self.DRIVE = os.getenv('TDRIVE')
        self.USERNAME = os.getenv('TUSERNAME')
        self.PASSWORD = os.getenv('TPASSWORD')
        self.HOST = os.getenv('THOST')
        self.PORT = os.getenv('TPORT')
        self.DATABASE_NAME = os.getenv('TDATABASE_NAME')
